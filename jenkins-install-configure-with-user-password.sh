...
read -p "Enter new username for Jenkins: " 
read -s -p "Enter password for $USERNAME: "
...
# Create user and set password using Jenkins CLI
java -jar jenkins-cli.jar -s http://localhost:8080/ -auth admin:$INITIAL_ADMIN_PASSWORD create-user $USERNAME $PASSWORD
